...
apt-get --no-install-recommends -y -t jessie-backports install apt-transport-https libterm-readline-perl-perl locales mc net-tools nginx openjdk-8-jre openjdk-8-jre-headless ca-certificates-java
